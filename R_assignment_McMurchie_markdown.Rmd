...
for (i in 1:10) {
  temp_df <- sort_maize %>%
    filter(Chromosome == i) 
write.table(temp_df, file = paste("maize_chr",i,".tsv", sep = ""), row.names = FALSE, col.names = TRUE)
}
...
for (i in 1:10) {
  temp_df <- maize_dash %>%
    filter(Chromosome == i) 
write.table(temp_df, file = paste("maize_dash_chr",i,".tsv", sep = ""), row.names = FALSE, col.names = TRUE)
}
...
for (i in 1:10) {
  temp_df <- sort_teosinte %>%
    filter(Chromosome == i) 
write.table(temp_df, file = paste("teosinte_chr",i,".tsv", sep = ""), row.names = FALSE, col.names = TRUE)
}
...
for (i in 1:10) {
  temp_df <- teosinte_dash %>%
    filter(Chromosome == i) 
write.table(temp_df, file = paste("teosinte_dash_chr",i,".tsv", sep = ""), row.names = FALSE, col.names = TRUE)
}
...
ggsave("zygo_sample_plot.pdf", plot = big_zygo_sample_plot, width = 15, height = 5, units = "in", dpi = 300) # print to pdf

ggsave("zygo_sample_plot.png", plot = big_zygo_sample_plot, width = 15, height = 5, units = "in", dpi = 300) # print to png
```
